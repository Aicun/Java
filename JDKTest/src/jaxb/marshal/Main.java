...
public class Main {
    ...
    public static void main( String[] args ) {
        try {
            ...
            try {
                Schema schema = sf.newSchema(new File("D:\\work\\opensource\\trunk\\samples\\jaxb-ri\\samples\\unmarshal-validate\\po.xsd"));
                u.setSchema(schema);
                u.setEventHandler(
            ...
            Object poe = 
                u.unmarshal( new File( "D:\\work\\opensource\\trunk\\samples\\jaxb-ri\\samples\\unmarshal-validate\\po.xml" ) );
